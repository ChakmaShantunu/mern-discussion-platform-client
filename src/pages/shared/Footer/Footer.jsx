...
const Footer = () => {
    return (
        <footer className="footer sm:footer-horizontal bg-base-200 text-base-content p-10 rounded-2xl">
            <aside>
                <div className='flex items-center'>
                    <img className='hidden md:block lg:block' alt="" />
                    <Link to='/' onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="text-xl font-bold hidden md:block lg:block">QuickPost.io</Link>
                </div>
